...
//   const [useNewEpisodeName, setUseNewEpisodeName] = useState(false);
...
//       // Extract unique episode names and convert to uppercase
//       const episodeNames = [...new Set(videos.map(video => (video.episodeName || video.videoTitle).toUpperCase()).filter(Boolean))];
...
//       const upperCaseFields = ['videoTitle', 'episodeName', 'genre', 'actors', 'writers', 'countries', 'languages'];
...
//           // Send arrays as comma-separated strings instead of individual array elements
...
//                             className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-blue-500"
//                           >
//                             <option value="">Select existing episode...</option>
...
//                             type="button"
//                             onClick={() => {
//                               setUseNewEpisodeName(true);
//                               setFormData(prev => ({ ...prev, episodeName: '' }));
//                             }}
//                             className="text-sm text-blue-400 hover:text-blue-300 underline"
//                           >
//                             Or enter new episode name
//                           </button>
//                         </div>
//                       ) : (
//                         <div className="space-y-2">
...
//                             value={formData.episodeName}
//                             onChange={handleInputChange}
//                             placeholder="Enter new episode name"
//                             className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-blue-500"
//                           />
//                           <button
//                             type="button"
              ...
              <div className="p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    {/* Trailer File - Conditionally Rendered */}
                    {useNewEpisodeName && (
                      <div>
                        <label className="block text-sm font-medium text-gray-300 mb-2">
                          Trailer Video
