...
const ManageSubscriptions = () => {
  ...
  const handlePlanSubmit = async (e) => {
    ...
    try {
      if (editingPlan) {
        // Update plan (API endpoint would need to be implemented)
  ...
  const handleTogglePlanStatus = async (planCode, currentStatus) => {
    try {
      await subscriptionsAPI.updatePlanStatus(planCode, !currentStatus);
  ...
  const handleDeletePlan = async (planCode) => {
    if (window.confirm('Are you sure you want to delete this plan?')) {
      try {
        // Delete plan API call would go here
                    ...
                    <tr key={plan.code} className="hover:bg-gray-800 transition-colors">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div>
                          ...
                          <div className="text-sm text-gray-400">{plan.code}</div>
                          {plan.description && (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="series">Per Series</option>
                      </select>
                    </div>
